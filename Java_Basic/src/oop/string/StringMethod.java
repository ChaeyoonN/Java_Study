...
public class StringMethod {
	...
	public static void main(String[] args) {
		...
		String str2 = new String("Hello java");// 똑같은 의미. 근데 이건 객체 확실히 만듦.
		String str3 = "Hello java";//str과 같은 문자열이므로 
		//객체를 새로 생성하지 않고 pool에서의 같은 주소값을 변수에 저장. 
		...
		String lower = strr.toLowerCase();//일괄 소문자 변경
		System.out.println("lower: "+lower);
		
		String upper = strr.toUpperCase();//일괄 대문자 변경
		...
		System.out.println(java.replace("습니", ""));//지우는 효과
		...
		//문자열의 정수/실수 변환
		String s1 = "100";//순수한 정수, 실수여야 한다. $100 (x)
		String s2 = "3.14";
