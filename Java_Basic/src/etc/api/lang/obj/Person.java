...
public class Person implements Cloneable {
	...
	//hashCode의 값도 그에 맞게 재정의가 되어야 합니다. (hash 주소를 equals에 맞게 정의)
	@Override
	public int hashCode() {
		return Objects.hash(age, name); //복사된 객체의 주소값을 복사한 객체 주소값과 같게 함
	}
	...
	protected void finalize() throws Throwable {
		...
		System.out.println(this.name+"이(가) 주겄습니다ㅜㅜ");
	}
