...
public class ArrayListExample {
	...
	public static void main(String[] args) {
        ...
        */
		...
		//다형성 적용. 변수 타입을 인터페이스타입으로 함.
		//<제네릭:타입 안정성 위해 타입고정시키는역할 default는 Object>();
		String str = "야옹이";
...
//		String name = nick[3]; (x) 배열의 방법
		...
		int idx = nick.indexOf("어흥이"); //없는 객체면 -1
		...
		/*
		 # 컬렉션 객체들은 Collections의 기능을 사용할 수 잇습니다.
		 Collections는 컬렉션 객체들의 부가 기능들을 지원합니다.
		 */
		
		List<Integer> score = new ArrayList<>();//객체 타입만이 들어간다.
		score.add(65); //오토 박싱
		...
		//컬렉션에서의 등장 횟수 구하기
		System.out.println("100점 맞은 학생 수: "
...
//		Collections.reverse(score); //역순 정렬(배치만 거꾸로)
