...
public class HashMapExample {
	...
	public static void main(String[] args) {
        ...
        */
		...
		map.put("야옹이", "홍길동");
		map.put("짹짹이", "박영희");
		System.out.println(map); //toString() 생략
		
		//Map은 Key의 중복 저장을 허용하지 않는다.
		//만약 중복 Key를 사용하여 put을 호출하면 Value만 수정됩니다.
		map.put("멍멍이", "김뽀삐"); //key 중복 -> 허용안하므로 value 덮어씀
		map.put("어흥이", "홍길동"); //value 중복 -> 허용하므로 데이터 추가됨.
		...
		System.out.println(map.get("메뚜기"));//없는 키면 null
