...
public class HashSetExample {
	...
	public static void main(String[] args) {
        ...
        */
		...
		//set을 list로 변환 -> 생성자의 매개값으로 set을 전달. 반대도 가능!
		...
		/*
		 # 객체에서 equals메서드를 오버라이딩할 때 hashCode도 같이 오버라이딩해야 하는 이유
		...
		System.out.println(kim.hashCode()+", "+kim2.hashCode());
		System.out.println(personSet); //중복저장 여부를 hashCode()로 확인
